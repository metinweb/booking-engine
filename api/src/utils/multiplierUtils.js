 ...
 */
export function calculateCombinationMultiplier(adults, children, adultMultipliers, childMultipliers) {
	// Yetişkin çarpanı
...
export function generateCombinationTable(occupancy, ageGroups, adultMultipliers = null, childMultipliers = null) {
	...
	for (let adults = 1; adults <= maxAdults; adults++) {
		...
		combinations.push({
			...
			adults,
			children: [],
			calculatedMultiplier: calculateCombinationMultiplier(adults, [], adultMultipliers, childMultipliers),
