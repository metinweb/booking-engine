...
campaignSchema.statics.getCampaignTemplates = function() {
	return [
		{
			type: 'early_bird',
			name: { tr: 'Erken Rezervasyon', en: 'Early Bird', de: 'Frühbucher', ru: 'Раннее бронирование' },
		...
		{
			type: 'long_stay',
			name: { tr: 'Uzun Konaklama', en: 'Long Stay', de: 'Langzeitaufenthalt', ru: 'Длительное проживание' },
