...
const getHotels = async (params = {}) => {
  try {
    ...
    apiLogger.error('Hotel Service: Get hotels failed', error.response?.data || error.message)
    throw error
  }
}
...
const getHotel = async id => {
  try {
    ...
    apiLogger.error('Hotel Service: Get hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const createHotel = async data => {
  try {
    ...
    apiLogger.error('Hotel Service: Create hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const updateHotel = async (id, data) => {
  try {
    ...
    apiLogger.error('Hotel Service: Update hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const deleteHotel = async id => {
  try {
    ...
    apiLogger.error('Hotel Service: Delete hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const updateHotelStatus = async (id, status) => {
  try {
    ...
    apiLogger.error('Hotel Service: Update status failed', error.response?.data || error.message)
    throw error
  }
}
...
const toggleFeatured = async (id, featured) => {
  try {
    ...
    apiLogger.error('Hotel Service: Toggle featured failed', error.response?.data || error.message)
    throw error
  }
}
...
const uploadImage = async (hotelId, file, caption = {}) => {
  try {
    ...
    apiLogger.error('Hotel Service: Upload image failed', error.response?.data || error.message)
    throw error
  }
}
...
const deleteImage = async (hotelId, imageId) => {
  try {
    ...
    apiLogger.error('Hotel Service: Delete image failed', error.response?.data || error.message)
    throw error
  }
}
...
const reorderImages = async (hotelId, imageIds) => {
  try {
    ...
    apiLogger.error('Hotel Service: Reorder images failed', error.response?.data || error.message)
    throw error
  }
}
...
const setMainImage = async (hotelId, imageId) => {
  try {
    ...
    apiLogger.error('Hotel Service: Set main image failed', error.response?.data || error.message)
    throw error
  }
}
...
const uploadLogo = async (hotelId, file) => {
  try {
    ...
    apiLogger.error('Hotel Service: Upload logo failed', error.response?.data || error.message)
    throw error
  }
}
...
const deleteLogo = async hotelId => {
  try {
    ...
    apiLogger.error('Hotel Service: Delete logo failed', error.response?.data || error.message)
    throw error
  }
}
...
const getCities = async () => {
  try {
    ...
    apiLogger.error('Hotel Service: Get cities failed', error.response?.data || error.message)
    throw error
  }
}
...
const getAvailableBases = async (params = {}) => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Get available bases failed',
...
const linkToBase = async baseId => {
  try {
    ...
    apiLogger.error('Hotel Service: Link to base failed', error.response?.data || error.message)
    throw error
  }
}
...
const unlinkFromBase = async hotelId => {
  try {
    ...
    apiLogger.error('Hotel Service: Unlink from base failed', error.response?.data || error.message)
    throw error
  }
}
...
const getBaseHotels = async (params = {}) => {
  try {
    ...
    apiLogger.error('Hotel Service: Get base hotels failed', error.response?.data || error.message)
    throw error
  }
}
...
const getBaseHotel = async id => {
  try {
    ...
    apiLogger.error('Hotel Service: Get base hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const getLinkedPartners = async id => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Get linked partners failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const createBaseHotel = async data => {
  try {
    ...
    apiLogger.error('Hotel Service: Create base hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const updateBaseHotel = async (id, data) => {
  try {
    ...
    apiLogger.error('Hotel Service: Update base hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const deleteBaseHotel = async id => {
  try {
    ...
    apiLogger.error('Hotel Service: Delete base hotel failed', error.response?.data || error.message)
    throw error
  }
}
...
const promoteToBase = async hotelId => {
  try {
    ...
    apiLogger.error('Hotel Service: Promote to base failed', error.response?.data || error.message)
    throw error
  }
}
...
const aiExtractHotelData = async params => {
  try {
    ...
    apiLogger.error('Hotel Service: AI extract failed', error.response?.data || error.message)
    throw error
  }
}
...
const startAiExtraction = async params => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Start AI extraction failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const getExtractionResult = async operationId => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Get extraction result failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const getRoomTemplates = async hotelId => {
  try {
    ...
    apiLogger.error('Hotel Service: Get room templates failed', error.response?.data || error.message)
    throw error
  }
}
...
const createRoomTemplate = async (hotelId, data) => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Create room template failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const updateRoomTemplate = async (hotelId, code, data) => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Update room template failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const deleteRoomTemplate = async (hotelId, code) => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Delete room template failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const uploadRoomTemplateImage = async (hotelId, code, file, caption = {}) => {
  try {
    ...
    const response = await apiClient.post(
      `/hotels/base/${hotelId}/room-templates/${code}/images`,
      formData,
      {
        headers: {
          'Content-Type': 'multipart/form-data'
    ...
    apiLogger.error(
      'Hotel Service: Upload room template image failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const deleteRoomTemplateImage = async (hotelId, code, imageId) => {
  try {
    const response = await apiClient.delete(
      `/hotels/base/${hotelId}/room-templates/${code}/images/${imageId}`
    )
    return response.data
  } catch (error) {
    apiLogger.error(
      'Hotel Service: Delete room template image failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const setRoomTemplateMainImage = async (hotelId, code, imageId) => {
  try {
    const response = await apiClient.patch(
      `/hotels/base/${hotelId}/room-templates/${code}/images/${imageId}/main`
    )
    return response.data
  } catch (error) {
    apiLogger.error(
      'Hotel Service: Set room template main image failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const reorderRoomTemplateImages = async (hotelId, code, imageIds) => {
  try {
    const response = await apiClient.patch(
      `/hotels/base/${hotelId}/room-templates/${code}/images/reorder`,
      { imageIds }
    )
    return response.data
  } catch (error) {
    apiLogger.error(
      'Hotel Service: Reorder room template images failed',
      error.response?.data || error.message
    )
    throw error
  }
...
const getImportableRooms = async hotelId => {
  try {
    ...
    apiLogger.error(
      'Hotel Service: Get importable rooms failed',
      error.response?.data || error.message
    )
    throw error
  }
