<template>
  <div class="space-y-6">
    <div>
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Faturalama Ayarlari</h3>
      <p class="text-sm text-gray-500 dark:text-slate-400">Fatura numaralama ve sirket bilgileri</p>
    </div>

    <!-- Invoice Numbering -->
    <div class="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-4">
      <h4 class="font-medium text-gray-900 dark:text-white mb-4">Fatura Numaralama</h4>
      <div class="space-y-4">
    ...
    <!-- Company Info -->
    <div class="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-4">
      <h4 class="font-medium text-gray-900 dark:text-white mb-4">Sirket Bilgileri</h4>
