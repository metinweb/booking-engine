    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p class="text-2xl font-bold text-gray-900 dark:text-white">
            {{ dashboardData.todayDepartures || 0 }}
          </p>
          ...
          <div class="divide-y divide-gray-100 dark:divide-slate-700 max-h-80 overflow-y-auto">
            ...
            >
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-xs text-gray-500 dark:text-slate-400">
                    {{
                      reservation.rooms?.[0]?.roomTypeName?.tr ||
                      reservation.rooms?.[0]?.roomTypeCode
                    }}
              ...
              <div class="text-right flex-shrink-0 ml-3">
                ...
                <p class="text-xs text-gray-500 dark:text-slate-400">
                  {{ reservation.totalAdults }} yetiskin<span v-if="reservation.totalChildren"
...
const totalPending = computed(() => {
  return (
    (dashboardData.value.todayArrivals || 0) +
