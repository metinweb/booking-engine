  ...
  <div>
    ...
    >
      <form @submit.prevent="handleSubmit" class="space-y-6">
        <!-- Basic Information -->
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">{{ $t('partners.basicInfo') }}</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label class="form-label">{{ $t('partners.companyName') }} *</label>
              <input
            ...
            <div>
              ...
              <input
                ...
                maxlength="20"
              />
              <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">{{ $t('partners.codeDescription') }}</p>
            </div>
        ...
        <!-- Address -->
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">{{ $t('partners.address') }}</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <Modal
      ...
      :title="$t('partners.approvePartner')"
      size="sm"
    >
      <p class="text-gray-600 dark:text-slate-400">
...
const columns = [
  { key: 'companyName', label: t('partners.companyName') },
