<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Rezervasyonlar</h1>
        <p class="text-gray-500 dark:text-slate-400 mt-1">Otel rezervasyonlarini yonetin</p>
      </div>
      <button
