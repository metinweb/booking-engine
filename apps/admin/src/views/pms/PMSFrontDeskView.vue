<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Resepsiyon</h1>
        <p class="text-gray-500 dark:text-slate-400 mt-1">Check-in, Check-out ve Misafir Yonetimi</p>
      </div>
...
import StayDetailModal from '@/components/pms/frontdesk/StayDetailModal.vue'
