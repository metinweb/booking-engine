  ...
  <div class="space-y-8">
    ...
    <div>
      ...
      <p class="text-sm text-gray-500 dark:text-slate-400 mb-6">
        {{ $t('hotels.contact.facilityContacts') }}
      </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <FormField
          ...
          :disabled="readonly"
          :rules="readonly ? [] : [{ email: true, message: $t('validation.email') }]"
          @validation-change="
            ({ field, error }) => handleFieldValidation(field || 'contact.email', error)
          "
        />
    ...
    <div class="pt-6 border-t border-gray-200 dark:border-slate-700">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <PhoneInput
          ...
          :label="$t('hotels.contact.authorizedPhone')"
          country="TR"
          :disabled="readonly"
        />
      </div>
