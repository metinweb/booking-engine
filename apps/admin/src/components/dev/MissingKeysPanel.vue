  ...
  <Teleport to="body">
    <div v-if="store.isDev" class="fixed bottom-4 right-4 z-[9999]">
      ...
      >
        <!-- Header -->
        <div
          class="flex items-center justify-between p-3 border-b border-gray-200 dark:border-slate-700 bg-amber-50 dark:bg-amber-900/20 rounded-t-lg"
        >
        ...
        <!-- Footer -->
        <div
          class="p-2 border-t border-gray-200 dark:border-slate-700 text-xs text-gray-500 dark:text-slate-400 text-center"
        >
