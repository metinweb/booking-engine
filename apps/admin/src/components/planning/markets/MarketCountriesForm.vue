  ...
  <div class="space-y-6">
    ...
    <div class="border border-gray-200 dark:border-slate-600 rounded-lg overflow-hidden">
      <div class="max-h-96 overflow-y-auto">
        <div
          class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-200 dark:bg-slate-600"
        >
          <div
      ...
      <div
        ...
        class="p-8 text-center text-gray-500 dark:text-slate-500"
      >
