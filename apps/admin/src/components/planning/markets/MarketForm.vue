    ...
    <div class="space-y-6 flex-1 overflow-y-auto overflow-x-hidden mt-6">
      ...
      <div v-show="activeTab === 'general'">
        ...
        >
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                ...
                "
                @click="
                  form.childAgeSettings.inheritFromHotel = !form.childAgeSettings.inheritFromHotel
                "
              >
                <span
                  class="absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transform transition-transform duration-300"
                  :class="
                    form.childAgeSettings.inheritFromHotel ? 'translate-x-6' : 'translate-x-0'
                  "
                ></span>
              </button>
            </div>
          ...
          <div
            v-if="form.childAgeSettings.inheritFromHotel"
          ...
          <div v-else>
            ...
            <p
              v-if="!form.childAgeSettings.childAgeGroups.length"
        ...
        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg space-y-4 mb-4">
          ...
          <div class="flex flex-wrap gap-3">
            <label
              ...
              :class="
                form.ratePolicy === policy.value
                  ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/20'
                  : 'border-gray-200 dark:border-slate-600 hover:border-gray-300'
              "
            >
              <input v-model="form.ratePolicy" type="radio" :value="policy.value" class="sr-only" />
          ...
          <div
            v-if="form.ratePolicy !== 'refundable'"
        ...
        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg space-y-4 mb-4">
          ...
          >
            <div class="flex items-center gap-3">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  v-model="form.taxes.vat.enabled"
                  type="checkbox"
                  class="rounded border-gray-300 text-indigo-600"
                />
            ...
            <div v-if="form.taxes.vat.enabled" class="flex items-center gap-3">
              <div class="flex items-center gap-2">
                <input
                  v-model.number="form.taxes.vat.rate"
                  type="number"
                  min="0"
                  max="100"
              ...
              <label class="flex items-center gap-1 text-sm cursor-pointer">
                <input
                  v-model="form.taxes.vat.included"
                  type="checkbox"
                  class="rounded border-gray-300 text-indigo-600"
                />
          ...
          >
            <div class="flex items-center gap-3">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  v-model="form.taxes.cityTax.enabled"
                  type="checkbox"
                  class="rounded border-gray-300 text-indigo-600"
                />
            ...
            <div v-if="form.taxes.cityTax.enabled" class="grid grid-cols-2 gap-3">
              <div>
                ...
                <select v-model="form.taxes.cityTax.type" class="form-select text-sm">
                  ...
                  <option value="fixed_per_night">
                    {{ $t('planning.markets.fixedPerNight') }}
                  </option>
              ...
              <div>
                ...
                <div class="flex items-center gap-2">
                  <input
                    v-model.number="form.taxes.cityTax.amount"
                    type="number"
                    min="0"
                    class="form-input text-sm"
                  />
                  <span class="text-sm text-gray-500">{{
                    form.taxes.cityTax.type === 'percentage' ? '%' : form.currency
                  }}</span>
                </div>
              </div>
            </div>
          ...
          >
            <div class="flex items-center gap-3">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  v-model="form.taxes.serviceCharge.enabled"
                  type="checkbox"
                  class="rounded border-gray-300 text-indigo-600"
                />
            ...
            <div v-if="form.taxes.serviceCharge.enabled" class="flex items-center gap-3">
              <div class="flex items-center gap-2">
                <input
                  v-model.number="form.taxes.serviceCharge.rate"
                  type="number"
                  min="0"
                  max="100"
                  class="form-input w-16 text-center text-sm"
              ...
              <label class="flex items-center gap-1 text-sm cursor-pointer">
                <input
                  v-model="form.taxes.serviceCharge.included"
                  type="checkbox"
                  class="rounded border-gray-300 text-indigo-600"
                />
                <span class="text-gray-600 dark:text-slate-400">{{
        ...
        <div class="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg space-y-4">
          ...
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              v-model="form.cancellationPolicy.useHotelPolicy"
              type="checkbox"
              class="rounded border-gray-300 text-indigo-600"
            />
          ...
          <div
            v-if="!form.cancellationPolicy.useHotelPolicy"
          ...
          >
            ...
            <div>
              ...
              <div
                v-for="(rule, index) in form.cancellationPolicy.penaltyRules"
                :key="index"
              ...
              >
                ...
                <div class="flex items-center gap-1">
                  <input
                    v-model.number="rule.penaltyValue"
                    type="number"
                    min="0"
                    class="form-input w-16 text-center text-sm"
                  />
            ...
            <div class="flex items-center gap-3">
              ...
              <select
                v-model="form.cancellationPolicy.noShowPenalty.type"
