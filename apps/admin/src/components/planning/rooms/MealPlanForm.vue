  ...
  <div class="space-y-6">
    ...
    <div>
      <label class="form-label"
        >{{ $t('planning.mealPlans.code') }} <span class="text-red-500">*</span></label
      >
      <input
        v-model="form.code"
        type="text"
    ...
    <div>
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg"
      >
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.breakfast"
            type="checkbox"
        ...
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.lunch"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
        ...
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.dinner"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
        ...
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.snacks"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
            $t('planning.mealPlans.meals.snacks')
          }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.drinks"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
        ...
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.alcoholicDrinks"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
        ...
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.minibar"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
            $t('planning.mealPlans.meals.minibar')
          }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
          <input
            v-model="form.includedMeals.roomService"
            type="checkbox"
            class="rounded border-gray-300 text-indigo-600"
          />
          <span class="text-sm text-gray-700 dark:text-slate-300">{{
            $t('planning.mealPlans.meals.roomService')
          }}</span>
        </label>
      </div>
    </div>
