<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="relative">
        <label class="form-label"
          >{{ $t('planning.roomTypes.code') }} <span class="text-red-500">*</span></label
        >
        <div class="relative">
          <input
            ref="codeInputRef"
    ...
    <div>
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg"
      >
        <div>
          <label class="text-xs text-gray-500 dark:text-slate-400">{{
            $t('planning.roomTypes.maxAdults')
          }}</label>
          <input
        ...
        <div>
          <label class="text-xs text-gray-500 dark:text-slate-400">{{
            $t('planning.roomTypes.maxChildren')
          }}</label>
          <input
        ...
        <div>
          <label class="text-xs text-gray-500 dark:text-slate-400">{{
            $t('planning.roomTypes.maxInfants')
          }}</label>
          <input
    ...
    <div>
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-2 max-h-48 overflow-y-auto p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg"
      >
        <label
        ...
        >
          ...
          <span class="text-gray-700 dark:text-slate-300">{{
            $t(`planning.roomTypes.amenities.${amenity}`)
          }}</span>
        </label>
      </div>
    </div>
