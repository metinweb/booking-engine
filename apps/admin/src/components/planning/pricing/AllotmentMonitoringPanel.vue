  ...
  >
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center gap-2">
        ...
        <h5 class="font-medium text-gray-700 dark:text-gray-300">
          {{ $t('planning.pricing.allotmentMonitoring') }}
        </h5>
      </div>
      <button
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
      ...
      <div
        ...
        :class="
          stats.critical > 0 ? 'bg-red-100 dark:bg-red-900/30' : 'bg-gray-100 dark:bg-slate-700'
        "
        ...
        <div class="flex items-center gap-2">
          ...
          <div>
            <div
              ...
              :class="stats.critical > 0 ? 'text-red-600' : 'text-gray-500'"
            >
              {{ stats.critical }}
            </div>
      ...
      <div
        class="p-3 rounded-lg cursor-pointer transition-all hover:scale-105"
        :class="
          stats.low > 0 ? 'bg-amber-100 dark:bg-amber-900/30' : 'bg-gray-100 dark:bg-slate-700'
        "
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <div>
            <div
              class="text-lg font-bold"
              :class="stats.low > 0 ? 'text-amber-600' : 'text-gray-500'"
            >
              {{ stats.low }}
            </div>
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <div>
            <div
              class="text-lg font-bold"
              :class="stats.stopSale > 0 ? 'text-purple-600' : 'text-gray-500'"
            >
              {{ stats.stopSale }}
            </div>
    ...
    <Transition name="slide-down">
      <div v-if="showDetails" class="mt-4 space-y-2">
        <div class="text-xs font-medium text-gray-500 mb-2">
          {{ $t('planning.pricing.detailedBreakdown') }}
        </div>
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span :class="getMealPlanBadgeClass(detail.mealPlanCode)">{{
              detail.mealPlanCode
            }}</span>
          </div>
