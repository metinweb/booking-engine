  ...
  <div class="pricing-tab">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <!-- Add Rate Button -->
        <button class="btn-primary flex items-center gap-2" @click="openBulkModal">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <div class="flex items-center gap-2 mb-3">
              ...
              >
                <span class="material-icons text-purple-600 dark:text-purple-400 text-lg"
                  >hotel</span
                >
              </div>
    ...
    <div class="content-area">
      ...
      <template v-else-if="viewMode === 'period'">
        ...
        <div v-else class="text-center py-16 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
          ...
          <button class="btn-primary mt-4" @click="openBulkModal">
    ...
    <Modal v-model="showDeleteConfirm" title="⚠️ Fiyat Verilerini Sil" size="sm">
      <div class="text-center py-4">
        <div
...
// filteredRates, priceListMealPlans, activeMealPlans, unifiedPeriods, getPeriodPrice, getFirstPeriodRate removed - were unused
...
// formatTodayDate and getSeasonTimelineRanges removed - were unused
...
// formatPrice, getMealPlanBadgeClass, getAllotmentClass removed - were unused
...
// getMealPlanHeaderClass removed - was unused
...
// hasExtraPricing removed - was unused
...
// editRate and confirmDeleteRate removed - were unused
