<template>
  <div v-if="authStore.isPlatformAdmin" class="relative" ref="dropdownRef">
    <button
      ...
      :class="{
        'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400': partnerStore.hasSelectedPartner
      }"
    >
    ...
    >
      ...
      >
        ...
        <button
          ...
          :class="{
            'text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20': !partnerStore.hasSelectedPartner
          }"
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-h-64 overflow-y-auto">
          ...
          <div v-else-if="partners.length > 0">
            <button
              ...
              :class="{
                'text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20': partnerStore.selectedPartner?._id === partner._id
              }"
            >
              ...
              <svg v-if="partnerStore.selectedPartner?._id === partner._id" class="w-4 h-4 flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
