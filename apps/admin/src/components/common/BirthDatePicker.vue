<template>
  <div class="relative">
    ...
    <div
      ...
      :class="[inputClass, disabled ? 'opacity-50 cursor-not-allowed' : 'hover:border-purple-400']"
      @click="openPicker"
    >
        ...
        <div v-if="showPicker" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          >
            ...
            <div class="p-4">
              ...
              >
                <div
                  class="flex items-center justify-center gap-2 text-purple-700 dark:text-purple-300"
                >
                ...
                <div class="flex items-start gap-2 text-sm text-yellow-800 dark:text-yellow-300">
                  ...
                  <div>
                    ...
                    <p class="text-yellow-700 dark:text-yellow-400 text-xs mt-0.5">
                      {{
                        $t('booking.ageWarningMessage', {
                          searchAge: expectedAge,
                          checkInAge: ageAtCheckIn
                        })
                      }}
                    </p>
                  </div>
