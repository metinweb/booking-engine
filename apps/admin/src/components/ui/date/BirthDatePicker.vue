<template>
  <div class="ui-birth-date-picker relative">
    ...
    <div
      ...
      :class="[
        sizeClasses,
        disabled ? 'opacity-50 cursor-not-allowed bg-gray-100 dark:bg-slate-700' : 'bg-white dark:bg-slate-800 hover:border-indigo-400',
        ...
        <div v-if="showPicker" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
            ...
            <div class="p-4">
              ...
              <div class="grid grid-cols-3 gap-3 mb-4">
                ...
                <div>
                  ...
                  <div class="relative">
                    <select
                      v-model="selectedDay"
                      class="w-full text-center appearance-none pr-8 font-medium px-3 py-2 rounded-lg border
              ...
              <!-- Age Display -->
              <div v-if="currentAge !== null" class="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-3 mb-4">
                <div class="flex items-center justify-center gap-2 text-indigo-700 dark:text-indigo-300">
