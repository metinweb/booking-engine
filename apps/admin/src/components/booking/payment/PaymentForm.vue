<template>
	...
	>
		<form @submit.prevent="handleSubmit" class="space-y-6">
				...
				<div class="grid grid-cols-3 gap-3">
					...
					>
						<span
							...
							:class="form.type === type.value ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400'"
						>{{ type.icon }}</span>
						<span
							class="text-sm font-medium text-center"
							:class="form.type === type.value ? 'text-purple-700 dark:text-purple-300' : 'text-gray-600 dark:text-slate-400'"
			...
			<div v-if="form.type === 'bank_transfer'" class="space-y-4 p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
			...
			<div v-if="form.type === 'pay_at_checkin'" class="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
				<div class="flex items-start gap-3">
