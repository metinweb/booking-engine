<template>
  <div class="fixed inset-0 z-[60] overflow-y-auto">
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div
        class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md transform transition-all"
      >
        <!-- Header -->
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            ...
            <div
              ...
              :class="priceDifference?.isIncrease ? 'text-amber-600' : 'text-green-600'"
            >
              {{ priceDifference?.isIncrease ? '+' : ''
              }}{{ formatCurrency(priceDifference?.difference, priceDifference?.currency) }}
            </div>
          </div>
        ...
        <!-- Footer -->
        <div
          class="flex items-center justify-end gap-3 px-6 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50"
        >
          <button
...
const adjustmentType = ref(
  props.adjustment?.waived ? 'waive' : props.adjustment?.adjustedAmount ? 'custom' : 'keep'
)
