<template>
	...
	>
		...
		<div class="flex items-start justify-between mb-3">
			<div>
				<p class="text-xs text-gray-500 dark:text-slate-400">{{ $t('booking.confirmationNumber') }}</p>
		...
		<div class="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-slate-700">
			<div>
				...
				<p class="text-lg font-bold text-purple-600 dark:text-purple-400">
					{{ formatPrice(booking.pricing?.finalTotal || booking.pricing?.total, booking.pricing?.currency) }}
				</p>
			</div>
