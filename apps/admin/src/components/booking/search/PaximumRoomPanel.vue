<template>
  <div
    class="mt-4 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden"
  >
    <!-- Header -->
    <div
      class="px-4 py-3 bg-indigo-50 dark:bg-indigo-900/20 border-b border-gray-200 dark:border-slate-700"
    >
      <div class="flex items-center justify-between">
        ...
        <button class="text-gray-400 hover:text-gray-600 dark:hover:text-white" @click="closePanel">
