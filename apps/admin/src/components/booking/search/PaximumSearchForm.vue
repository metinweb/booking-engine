  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="relative">
        ...
        >
          ...
          >
            ...
            <span v-if="loc.hotelCount" class="text-xs text-gray-400"
              >{{ loc.hotelCount }} otel</span
            >
          </button>
        </div>
      </div>
      ...
      <div v-if="bookingStore.paximumSearch.location" class="mt-2">
        <span
          class="inline-flex items-center gap-1 px-2 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-lg text-xs"
        >
          ...
          <button class="ml-1 hover:text-red-500" @click="clearLocation">
    ...
    <div>
      ...
      <BookingDateRangePicker v-model="dateRange" :min-date="minDate" :has-error="dateError" />
    ...
    <div v-if="totalChildren > 0" class="flex flex-wrap gap-2">
      ...
      >
        ...
        <button class="text-indigo-400 hover:text-red-500" @click="removeChild(index)">
          <span class="material-icons text-xs">close</span>
        </button>
      </div>
    </div>
    ...
    <button
      ...
      @click="handleSearch"
    >
      <span v-if="bookingStore.loading.paximum" class="material-icons animate-spin mr-1.5 text-sm"
        >refresh</span
      >
