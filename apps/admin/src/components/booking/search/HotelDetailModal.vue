  ...
  <Teleport to="body">
    <transition name="modal-fade">
      ...
      >
        ...
        <!-- Modal Content -->
        <div
          class="relative w-full max-w-4xl max-h-[90vh] bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col"
        >
          <!-- Close Button -->
          <button
          ...
          <div class="relative h-72 md:h-96 bg-gray-900 flex-shrink-0">
            ...
            <div
              ...
              class="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/50 backdrop-blur-sm px-4 py-2 rounded-full text-white text-sm font-medium"
            >
            ...
            <div
              v-if="images.length > 1"
              class="absolute bottom-4 left-4 right-4 flex justify-center gap-2"
            >
              <button
            ...
            <div class="absolute top-4 left-4 right-16">
              <div class="flex items-center gap-2 mb-2">
                <div
                  v-if="hotel?.stars"
                  class="flex items-center gap-0.5 bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full"
                >
                  <span
            ...
            <div class="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div class="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-4 mb-4">
                  ...
                  <div class="space-y-2">
                    <div
                      v-if="hotel?.contact?.phone"
                      class="flex items-center gap-3 text-gray-600 dark:text-slate-300"
                    >
                      <span class="material-icons text-gray-400">phone</span>
                      <span>{{ hotel.contact.phone }}</span>
                    </div>
                    <div
                      v-if="hotel?.contact?.email"
                      class="flex items-center gap-3 text-gray-600 dark:text-slate-300"
                    >
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                  ...
                  <div class="space-y-2 text-sm">
                    <div
                      class="flex items-center justify-between text-gray-600 dark:text-slate-300"
                    >
                    ...
                    <div
                      v-if="hotel?.policies?.maxChildAge !== undefined"
                      class="flex items-center justify-between text-gray-600 dark:text-slate-300"
                    >
                      <span>{{ $t('booking.maxChildAge') }}</span>
                      <span class="font-medium"
                        >{{ hotel.policies.maxChildAge }} {{ $t('booking.yearsOld') }}</span
                      >
                    </div>
                  </div>
                </div>
          ...
          <!-- Footer Actions -->
          <div
            class="flex-shrink-0 p-4 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50"
          >
            <div class="flex items-center justify-between">
              ...
              <button class="btn-primary px-6 py-3 text-base font-medium" @click="selectHotel">
