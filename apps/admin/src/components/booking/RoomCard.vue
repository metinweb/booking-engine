<template>
	<div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
		...
		<div class="relative h-48 bg-gray-100 dark:bg-slate-700">
			...
			<!-- Capacity Badge -->
			<div class="absolute top-3 right-3 bg-white dark:bg-slate-800 rounded-full px-3 py-1 text-xs font-medium shadow">
				...
				>
					<div class="flex items-start justify-between">
						...
						<div class="text-right ml-4">
							...
							<p class="text-xs text-gray-500 dark:text-slate-400">
								~{{ formatPrice(option.pricing.avgPerNight, option.pricing.currency) }}/{{ $t('booking.perNight') }}
							</p>
						</div>
					</div>
