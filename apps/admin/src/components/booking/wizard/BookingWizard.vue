<template>
  <div class="min-h-screen bg-gray-50 dark:bg-slate-900">
    <!-- Header -->
    <div
      class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 sticky top-0 z-20"
    >
    ...
    <Modal v-model="showExitConfirm" :title="$t('booking.exitConfirmTitle')">
      ...
      <template #footer>
        <div class="flex space-x-3">
          <button class="btn-secondary flex-1" @click="showExitConfirm = false">
            {{ $t('common.cancel') }}
          </button>
          <button class="btn-primary flex-1" @click="confirmExit">
