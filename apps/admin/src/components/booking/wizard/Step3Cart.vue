<template>
	<div class="space-y-6">
		...
		<!-- Empty Cart -->
		<div v-if="bookingStore.cart.length === 0" class="text-center py-12 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
			...
			<button @click="$emit('go-back')" class="mt-4 btn-primary">
		...
		<div v-else class="space-y-4">
			...
			<div class="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 flex items-center space-x-4">
				<div class="w-16 h-16 rounded-lg bg-white dark:bg-slate-800 flex items-center justify-center flex-shrink-0">
				...
				>
					<div class="flex items-start justify-between">
						<div class="flex items-start space-x-4">
							<!-- Room Image -->
							<div class="w-20 h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-slate-700 flex-shrink-0">
								<img
