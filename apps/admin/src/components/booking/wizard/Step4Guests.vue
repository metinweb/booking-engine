	...
	<div class="space-y-6">
		...
		<div v-if="bookingStore.cart.length > 0 && isInitialized" class="space-y-6">
			...
			>
				...
				<div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3">
					<div class="flex items-center justify-between">
						<div class="flex items-center space-x-3">
							<div class="w-8 h-8 rounded-full bg-purple-200 dark:bg-purple-800 flex items-center justify-center">
				...
				<div v-if="(!useLeadAsFirstGuest || roomIndex > 0) && getAdultsForRoom(roomIndex).length > 0" class="space-y-4">
					<div
				...
				<div v-else-if="useLeadAsFirstGuest && roomIndex === 0" class="space-y-4">
					<div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 text-sm text-green-700 dark:text-green-400 flex items-center">
...
onMounted(async () => {
	...
	if (bookingStore.guests.roomGuests?.length > 0 &&
