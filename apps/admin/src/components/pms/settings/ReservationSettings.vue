      ...
      <div class="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white"
          />
          <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Kac gun oncesine kadar rezervasyon alinabilir</p>
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Otomatik Iptal (Saat)
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white"
          />
          <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Onay bekleyen rezervasyonlar icin</p>
        </div>
      </div>
      ...
      <div class="space-y-4 pt-4 mt-4 border-t border-gray-200 dark:border-slate-600">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-slate-400">Ayni gun icin rezervasyon kabul et</p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-slate-400">Rezervasyonlar manuel onay gerektirir</p>
          </div>
          <label class="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
