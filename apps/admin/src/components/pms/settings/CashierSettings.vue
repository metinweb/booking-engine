<template>
  <div class="space-y-6">
    <div>
      ...
      <p class="text-sm text-gray-500 dark:text-slate-400">Vardiya, para birimi ve odeme yontemi ayarlari</p>
    </div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
      ...
      <div class="flex flex-wrap gap-2">
        <label
          ...
          :class="isCurrencyActive(curr.code)
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-slate-400">Islem yapmak icin acik vardiya gerekir</p>
          </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-slate-600">
          <div>
            ...
            />
            <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Bos birakilirsa otomatik kapanmaz</p>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Kasa Fark Toleransi
