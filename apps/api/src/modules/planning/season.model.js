...
const seasonSchema = new mongoose.Schema(
  {
    ...
    // Season identification (admin-only: TR, EN)
    ...
    // Sales settings override (working mode, commission rate, markup)
    salesSettingsOverride: {
      ...
      // Agency margin share - percentage of total margin to give to agency
      agencyMarginShare: {
        type: Number,
        min: 0,
        max: 100,
    ...
    // Non-refundable option override
    nonRefundableOverride: {
      inheritFromMarket: { type: Boolean, default: true },
      enabled: { type: Boolean, default: false },
      discount: { type: Number, min: 0, max: 50, default: 10 }
    },
