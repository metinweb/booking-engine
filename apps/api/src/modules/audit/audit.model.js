...
const auditLogSchema = new mongoose.Schema({
  ...
  module: {
    type: String,
    required: true,
    enum: ['auth', 'user', 'partner', 'hotel', 'planning', 'booking',
           'content', 'settings', 'file', 'system', 'agency', 'location', 'tag'],
    index: true
  },
  ...
  action: {
    ...
    enum: ['create', 'update', 'delete', 'view', 'login', 'logout',
           'export', 'import', 'approve', 'reject', 'activate',
           'deactivate', 'link', 'unlink', 'upload', 'download'],
    index: true
  },
