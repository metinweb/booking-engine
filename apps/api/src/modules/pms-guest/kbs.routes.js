...
// Note: Authentication is handled by parent router (pms.routes.js)
// via pmsDualAuth middleware applied to /hotels/:hotelId routes

/**
 * @route   POST /api/pms/:hotelId/kbs/test-connection
...
/**
 * @route   POST /api/pms/:hotelId/kbs/send
...
/**
 * @route   POST /api/pms/:hotelId/kbs/send-stay
...
/**
 * @route   GET /api/pms/:hotelId/kbs/pending
...
/**
 * @route   POST /api/pms/:hotelId/kbs/generate-xml
...
/**
 * @route   POST /api/pms/:hotelId/kbs/mark-sent
...
/**
 * @route   GET /api/pms/:hotelId/kbs/report
...
/**
 * @route   PUT /api/pms/:hotelId/kbs/stays/:stayId/guests/:guestId
