 ...
 */
const PROFILE_FEATURE_TO_AMENITY = {
  // === Facilities Section ===
  wifi: 'wifi',
  freeWifi: 'wifi',
  parking: 'parking',
 ...
 */
function generateAmenitiesFromProfile(profile) {
  if (!profile) return []
 ...
 */
function mergeAmenitiesWithProfile(existingAmenities, profile) {
...
module.exports = {
  PROFILE_FEATURE_TO_AMENITY,
  VALID_AMENITIES,
  generateAmenitiesFromProfile,
  mergeAmenitiesWithProfile
}
