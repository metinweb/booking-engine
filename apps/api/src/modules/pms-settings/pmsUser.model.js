...
pmsUserSchema.methods.getRoleForHotel = function (hotelId) {
  const assignment = this.assignedHotels.find(
    h => getHotelId(h.hotel)?.toString() === hotelId.toString()
  )
...
pmsUserSchema.statics.getDefaultPermissions = function (role) {
  const permissionsByRole = {
    ...
    housekeeper: ['dashboard.view', 'housekeeping.view', 'housekeeping.updateStatus'],
    revenue_manager: [
      'dashboard.view',
      'reservations.view',
      'reports.operational',
