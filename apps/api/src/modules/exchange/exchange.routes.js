 ...
 * Admin only
 */
router.get('/history', protect, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * Admin only
 */
router.post('/refresh', protect, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * Admin only
 */
router.post('/manual-rate', protect, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * Admin only
 */
router.get('/scheduler-status', protect, requireAdmin, asyncHandler(async (req, res) => {
