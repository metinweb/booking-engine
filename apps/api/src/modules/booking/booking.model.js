...
const bookingSchema = new mongoose.Schema({
	...
	status: {
		type: String,
		enum: ['draft', 'pending', 'confirmed', 'checked_in', 'cancelled', 'completed', 'no_show', 'expired'],
		default: 'pending',
		index: true
	},
 ...
 */
bookingSchema.statics.convertDraftToBookingNumber = async function(draftNumber) {
