...
/**
 * @route   GET /api/pms/:hotelId/room-plan
...
/**
 * @route   PUT /api/pms/:hotelId/room-plan/stays/:stayId/dates
...
/**
 * @route   PUT /api/pms/:hotelId/room-plan/stays/:stayId/room
...
/**
 * @route   GET /api/pms/:hotelId/room-plan/rooms/:roomId/availability
