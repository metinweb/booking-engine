    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">{{ $t('hotels.statusHelp') }}</p>
        </div>
        ...
        <div class="flex items-center pt-6">
          <label class="flex items-center cursor-pointer">
            ...
            <span class="ml-3 text-sm text-gray-700 dark:text-slate-300">
              ...
              <span class="block text-xs text-gray-500 dark:text-slate-400 mt-0.5">{{ $t('hotels.featuredHelp') }}</span>
            </span>
          </label>
        </div>
      </div>
