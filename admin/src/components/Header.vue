  ...
  <header class="bg-white dark:bg-slate-800 shadow-sm border-b border-gray-200 dark:border-slate-700">
    <div class="px-3 md:px-6 py-3 md:py-4 flex justify-between items-center">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-lg md:text-xl font-semibold text-gray-800 dark:text-white">{{ pageTitle }}</h1>
          <p v-if="pageDescription && !uiStore.isMobile" class="text-sm text-gray-500 dark:text-slate-400 mt-1">{{ pageDescription }}</p>
        </div>
      </div>
