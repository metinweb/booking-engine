<template>
  <div>
    <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">{{ title || $t('partners.documentUpload') }}</h3>
    ...
    <div
      ...
      :class="dragOver ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-slate-600'"
    ...
    <div v-else class="text-center py-8 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-dashed border-gray-300 dark:border-slate-600">
...
const openLightbox = (doc) => {
  ...
  lightboxUrl.value = `http://localhost:4000/api/partners/${props.partnerId}/documents/${doc._id}/file`
