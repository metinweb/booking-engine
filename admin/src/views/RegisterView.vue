<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4">
    <div class="w-full max-w-md">
      <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-2xl font-bold text-gray-800 dark:text-white">{{ $t('auth.partnerRegister') }}</h2>
          <p class="text-gray-600 dark:text-slate-400 mt-2">{{ $t('auth.createPartnerAccount') }}</p>
        </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600 dark:text-slate-400">
            ...
            <RouterLink to="/login" class="text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 font-medium">
              {{ $t('auth.loginHere') }}
            </RouterLink>
          </p>
        </div>
