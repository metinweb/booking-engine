 ...
 */
const calculateRatePrice = async (hotelId, rateId, data) => {
	try {
		const response = await apiClient.post(`${BASE_URL}/hotels/${hotelId}/rates/${rateId}/calculate-price`, data)
		return response.data
	} catch (error) {
		console.error('Planning Service: Calculate rate price failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const calculatePriceByQuery = async (hotelId, data) => {
	try {
		const response = await apiClient.post(`${BASE_URL}/hotels/${hotelId}/pricing/calculate`, data)
		return response.data
	} catch (error) {
		console.error('Planning Service: Calculate price failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const bulkCalculatePrices = async (hotelId, queries) => {
	try {
		const response = await apiClient.post(`${BASE_URL}/hotels/${hotelId}/pricing/bulk-calculate`, { queries })
		return response.data
	} catch (error) {
		console.error('Planning Service: Bulk calculate prices failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const checkPricingAvailability = async (hotelId, data) => {
	try {
		const response = await apiClient.post(`${BASE_URL}/hotels/${hotelId}/pricing/check-availability`, data)
		return response.data
	} catch (error) {
		console.error('Planning Service: Check availability failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const getEffectiveRate = async (hotelId, params) => {
	try {
		const response = await apiClient.get(`${BASE_URL}/hotels/${hotelId}/pricing/effective-rate`, { params })
		return response.data
	} catch (error) {
		console.error('Planning Service: Get effective rate failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const getEffectiveMultipliers = async (hotelId, params) => {
	try {
		const response = await apiClient.get(`${BASE_URL}/hotels/${hotelId}/pricing/effective-multipliers`, { params })
		return response.data
	} catch (error) {
		console.error('Planning Service: Get effective multipliers failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const getCombinationTable = async (hotelId, params) => {
	try {
		const response = await apiClient.get(`${BASE_URL}/hotels/${hotelId}/pricing/combination-table`, { params })
		return response.data
	} catch (error) {
		console.error('Planning Service: Get combination table failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const getEffectiveChildAgeGroups = async (hotelId, params) => {
	try {
		const response = await apiClient.get(`${BASE_URL}/hotels/${hotelId}/pricing/child-age-groups`, { params })
		return response.data
	} catch (error) {
		console.error('Planning Service: Get child age groups failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const calculatePriceWithCampaigns = async (hotelId, data) => {
	try {
		const response = await apiClient.post(`${BASE_URL}/hotels/${hotelId}/pricing/calculate-with-campaigns`, data)
		return response.data
	} catch (error) {
		console.error('Planning Service: Calculate price with campaigns failed', error.response?.data || error.message)
		throw error
	}
}
 ...
 */
const getApplicableCampaigns = async (hotelId, params) => {
	try {
		const response = await apiClient.get(`${BASE_URL}/hotels/${hotelId}/pricing/applicable-campaigns`, { params })
		return response.data
	} catch (error) {
		console.error('Planning Service: Get applicable campaigns failed', error.response?.data || error.message)
		throw error
	}
}
